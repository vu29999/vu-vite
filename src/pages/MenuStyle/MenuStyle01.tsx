...
const MenuStyle01 = () => {
    ...
    const subBoxRefs = useRef<(HTMLDivElement | null)[]>([]);
    const location = useLocation();

    // Get max sub box height for bg height
    const getMaxSubBoxHeight = (): number => {
    ...
    return (
        <header>
                                    ...
                                    {menuData.map((menuItem: MenuItem, index: number) => {
                                        ...
                                        return (
                                            <li
                                                key={index}
                                                className={
                                                    hoverIndex === index || isMenuActive ? "on-menu" : ""
                                                }
                                                            ...
                                                            <ul className="depth_02">
                                                                {menuItem.sub.map((sub, subIndex) => {
                                                                    ...
                                                                    return (
                                                                        ...
                                                                        >
                                                                            <Link to={sub.path} title={sub.title}>
                                                                                {sub.title}
                                                                            </Link>
            ...
            <div className="wrap-test">test</div>
        </header>
    );
};
